...
@Component({
  ...
  styleUrl: './incomeForm.component.css',
})
export class IncomeFormComponent {
  ...
  frm = new FormGroup({
    ...
    halquaShare: new FormControl('', [Validators.required]),
    cityShare: new FormControl('', [Validators.required]),
    unitShare: new FormControl('', [Validators.required]),
    halquaId: new FormControl('', [Validators.required]),
    unitId: new FormControl('', [Validators.required]),
    oneTime: new FormControl(false),
  });
  ...
  ngOnInit() {
    this.dataService.data$.subscribe(data => {
      if (data != null) {
        ...
        this.frm.get('halquaShare')?.setValue(data.halquaShare)
        this.frm.get('cityShare')?.setValue(data.cityShare)
        this.frm.get('unitShare')?.setValue(data.unitShare)
      }
      else {
        this.frm.reset();
